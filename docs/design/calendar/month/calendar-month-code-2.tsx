        ...
        <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <Button
                  ...
                  style={
                    view === "today"
                      ? { backgroundColor: "#00C896", color: "white" }
                      : {}
                  }
                >
                  Today
          ...
          <div className="mb-6 flex items-center gap-3">
            <button
              ...
              className={`touch-target-lg flex items-center gap-2 rounded-full px-6 py-3 ${
          ...
          {view === "month" ? (
              ...
              <div className="grid grid-cols-7 gap-2">
                {monthDates.map((dateObj, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className={`aspect-square rounded-xl p-3 ${!dateObj.isCurrentMonth ? "opacity-40" : ""}`}
                      style={{
                      ...
                      <div className="space-y-1">
                        {[1, 2].map((i) => (
                          <div
                            ...
                            style={{
                              backgroundColor: isToday ? "white" : "#00C896",
                              opacity: 0.5,
                            }}
                          />
                        ))}
            ...
            <div className="flex-1 overflow-x-auto overflow-y-hidden">
              <div className="inline-flex min-w-max gap-4 pb-4">
                {weekDates.map((date, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className="flex-1 space-y-3 overflow-y-auto rounded-b-2xl p-4"
                        style={{
                      ...
                      >
                        {idx === 1 && (
                          <div className="space-y-2">
                            <label className="flex items-center gap-3 rounded-lg border-2 border-dashed border-blue-200 bg-blue-50 p-3">
                              <input
                                type="checkbox"
