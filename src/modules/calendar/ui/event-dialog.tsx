        ...
        <form action={formAction} className="flex flex-col gap-4">
          ...
          <Field>
            ...
            <div role="radiogroup" aria-label={t('form.category')} className="flex flex-wrap gap-2">
              <label className="flex cursor-pointer items-center gap-1.5 rounded-lg border border-border px-3 py-2 has-checked:border-ring has-checked:bg-accent">
                <input
                  type="radio"
                  name="category"
                  value=""
              ...
              {EVENT_CATEGORIES.map((category) => (
                <label
                  key={category}
                  className="flex size-12 cursor-pointer items-center justify-center rounded-lg border-2 border-transparent has-checked:border-ring"
          ...
          <Field>
            ...
            <div className="flex flex-wrap gap-2">
              {members.map((member) => (
                <label
                  key={member.id}
                  className="flex min-h-12 cursor-pointer items-center gap-2 rounded-lg border border-border px-3 has-checked:border-ring has-checked:bg-accent"
                >
                  <input
                    type="checkbox"
